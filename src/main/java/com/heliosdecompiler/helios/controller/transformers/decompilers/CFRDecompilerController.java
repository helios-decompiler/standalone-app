...
public class CFRDecompilerController extends DecompilerController<CFRSettings> {
    ...
    protected void registerSettings() {
        ...
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.SUGAR_STRINGCONCATFACTORY, true));
        ...
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.PREVIEW_FEATURES));
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.SWITCH_EXPRESSION, true));
        ...
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.REWRITE_TRY_RESOURCES, true));
        ...
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.SKIP_BATCH_INNER_CLASSES));
        ...
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.RELINK_CONSTANT_STRINGS));
...
//        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.DUMP_CLASS_PATH));
        ...
        registerSetting(Troolean.class, new RawTrooleanSetting(OptionsImpl.FORCE_TOPSORT_NOPULL));
        ...
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.IGNORE_EXCEPTIONS_ALWAYS));
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.IGNORE_EXCEPTIONS));
        ...
        registerSetting(Troolean.class, new RawTrooleanSetting(OptionsImpl.FORCE_AGGRESSIVE_EXCEPTION_AGG2));
...
//        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.JAR_FILTER));
        ...
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.USE_NAME_TABLE));
...
//        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.CASE_INSENSITIVE_FS_RENAME));
        registerSetting(Boolean.class, new RawBooleanSetting(OptionsImpl.LOMEM));
    }

    // :(
    private <T, V> OptionDecoderParam<T, V> getFn(PermittedOptionProvider.ArgumentParam<T, V> in) {
        try {
            Field field = PermittedOptionProvider.ArgumentParam.class.getDeclaredField("fn");
            field.setAccessible(true);
            return (OptionDecoderParam<T, V>) field.get(in);
    ...
    private class RawBooleanSetting extends Setting<Boolean, CFRSettings> {
        ...
        RawBooleanSetting(PermittedOptionProvider.Argument<Boolean> argument) {
            super(Boolean.class, Boolean.parseBoolean(getFn(argument).getDefaultValue()), ConfigurationSerializer.BOOLEAN, argument.getName(), getHelp(argument));
        }
    ...
    private class RawTrooleanSetting extends Setting<Troolean, CFRSettings> {
        ...
        RawTrooleanSetting(PermittedOptionProvider.Argument<org.benf.cfr.reader.util.Troolean> argument) {
            super(Troolean.class, Troolean.parseTroolean(getFn(argument).getDefaultValue()), ConfigurationSerializer.TROOLEAN, argument.getName(), getHelp(argument));
        }
    ...
    private class RawIntegerSetting extends IntegerSetting<CFRSettings> {
        RawIntegerSetting(PermittedOptionProvider.Argument<Integer> argument, int min, int max, int step) {
            super(Integer.class, Integer.parseInt(getFn(argument).getDefaultValue()), ConfigurationSerializer.INTEGER, argument.getName(), getHelp(argument), min, max, step);
        }
